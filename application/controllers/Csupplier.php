...
class Csupplier extends CI_Controller {
    ...
    public function insert_supplier()
    {
        ...
        $c_acc=$this->input->post('supplier_name',true).'-'.$supplier_id;
        ...
        if ($supplier == TRUE) {
              $this->db->insert('acc_coa',$supplier_coa);
                ...
                'chalan_no'     =>  $depid,
                'deposit_no'    =>  NULL,
                'amount'        =>  (!empty($this->input->post('previous_balance',true))?$this->input->post('previous_balance',true):0),
      ...
      'Debit'          =>  0,
      'Credit'         =>  (!empty($this->input->post('previous_balance',true))?$this->input->post('previous_balance',true):0),
      'IsPosted'       => 1,
      'CreateBy'       => $this->session->userdata('user_id'),
      'CreateDate'     => date('Y-m-d H:i:s'),
      'IsAppove'       => 1
      ...
      'Debit'          =>  (!empty($this->input->post('previous_balance',true))?$this->input->post('previous_balance',true):0),
      ...
      'IsAppove'       => 1
           ...
           if(!empty($this->input->post('previous_balance',true))){
