...
$api_key = '60d6748a';
$secret_key = 'NrW61s2AfTbgYkNk';
$from = 'Isahaq';
$to = '01748684764';//'01817584639';
$message = 'HiIamtest';

$url = 'https://rest.nexmo.com/sms/json?api_key='.$api_key.'&api_secret='.$secret_key.'&from='.$from.'&to='.$to.'&text='.$message;
