...
public function get_total_assets($asset_item_code,$store_code) {
    ...
    $item_c = $this->input->post('item_code',true);
    ...
    $sup_coa = $this->db->select('*')->from('acc_coa')->where('HeadName',$sup_head)->get()->row();
      ...
      $bcoaid = '';
        ...
        $data = array(
            'p_date'             => $this->input->post('purchase_date',true),
            'supplier_id'        => $this->input->post('supplier_id',true),
     ...
     $cashinhand = array(
      ...
      'Narration'      =>  'Inventory Debit For Purchase Assets Purchase No'.$purchase_id,
      'Debit'          =>  0,
      'Credit'         =>  $this->input->post('grand_total_price',true),//purchase price asbe
      'IsPosted'       => 1,
      'CreateBy'       => $receive_by,
      'CreateDate'     => $createdate,
      'IsAppove'       => 1
        ...
        $rate     = $this->input->post('item_price',true);
