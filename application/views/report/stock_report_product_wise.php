			                    ...
			                    <table class="table table-bordered table-striped table-hover">
									...
									{stok_report}
										<tr>
											...
											<td class="text-right">{totalPurchaseQnty}</td>
											<td class="text-right">{totalSalesQnty}</td>
											
											
											<td class="text-right">{SubTotalStock}</td>
										</tr>
									{/stok_report}
									<?php
										}
									...
									<tfoot>
										<tr>
											...
											<td class="text-right"><b>{SubTotalinQnty}</b></td>

											<td class="text-right"><b>{SubTotaloutQnty}</b></td>

											<td  class="text-right"><b>{sub_total_stock}</td>
										</tr>
									</tfoot>
			                    </table>
			                </div>
