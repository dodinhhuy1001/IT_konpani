		            	...
		            	<div id="purchase_div">
			                ...
			                <div class="table-responsive">
			                    <table class="table table-bordered table-striped table-hover">
									...
									?>
										{total_profit_report}
											<tr>
												...
												<td class="text-center"><?php echo (($position==0)?"$currency {total_manufacturer_rate}":"{total_manufacturer_rate} $currency") ?></td>
												<td class="text-center">
												<?php echo (($position==0)?"$currency {total_sale}":"{total_sale} $currency") ?>
												</td>
												<td class="text-center"><?php echo (($position==0)?"$currency {total_profit}":"{total_profit} $currency") ?></td>
											</tr>
										{/total_profit_report}
									<?php
										}
									...
									<tfoot>
										<tr>
											<td colspan="2" align="right"><b><?php echo display('total_profit') ?>: </b></td>

											<td class="text-center"><b><?php echo (($position==0)?"$currency {SubTotalSupAmnt}":"{SubTotalSupAmnt} $currency") ?></b></td>	

											<td class="text-center"><b><?php echo (($position==0)?"$currency {SubTotalSaleAmnt}":"{SubTotalSaleAmnt} $currency") ?></b></td>

											<td class="text-center"><b><?php echo (($position==0)?"$currency {profit_ammount}":"{profit_ammount} $currency") ?></b></td>
										</tr>
									</tfoot>
			                    </table>
			                </div>
