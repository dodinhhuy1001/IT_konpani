	                    	...
	                    	<div class="form-group row">
	                            ...
	                            <div class="col-sm-6">
		                            ...
		                            <?php if ($supplier){
		                             ...
		                             <option value="<?php echo $suppliers['supplier_id'];?>" <?php if($suppliers['supplier_id'] == $supplier_id){echo 'selected';}?>><?php echo $suppliers['supplier_name'];?>
		                                </option>
		                            <?php }} ?>
		                            </select>
	                            </div>
		            	...
		            	<div id="printableArea">
		            		...
		            		<div class="text-center">
								...
								<h4> <?php echo display('print_date') ?>: <?php if(!empty($start_date)){
									echo html_escape($start_date).' To '.html_escape($end_date);
								} ?> </h4>
							</div>
							<?php } ?>
									...
									if ($ledger) {
									 ...
									 ?>
										<tr>
											...
											<td>
												<a href="<?php echo base_url('Cpurchase/purchase_details_data/'. $ledger['transaction_id'])?>"><?php echo html_escape($ledger['chalan_no']) ?></a>
											</td>
											<td><?php echo html_escape($ledger['deposit_no']) ?></td>
											<td  align="right">
											<?php
											if ($ledger['debit']) {
