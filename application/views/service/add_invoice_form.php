                                     ...
                                     <label for="employee" class="col-sm-4 col-form-label"><?php
                                        ...
                                        <div class="col-sm-8">
                                            <select name="employee_id[]" class="form-control" multiple="multiple" required="">
                                                ...
                                                <option value="<?php echo html_escape($employee['id'])?>"><?php echo html_escape($employee['first_name']).' '.html_escape($employee['last_name'])?></option>
                                              <?php } ?>
                                ...
                                <tbody id="addinvoiceItem">
                                    <tr>
                                        <td class="product_field">
                                            ...
                                            <input type="hidden" id="discount_type" name="" value="<?php echo $discount_type;?>">
