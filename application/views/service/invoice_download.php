    ...
    <div class="firts_section" style="">
        ...
        <div class="first_section_right"  style="width: 28%; display: inline-block;">
            <h2 style="margin: 0px;"><?php echo display('service') ?></h2>
                                    <div><?php echo display('voucher_no') ?>: <?php echo html_escape($invoice_id);?></div>
                                    <div class="m-b-15"><?php echo display('hanging_over') ?>: <?php echo html_escape($final_date);?></div>

                                    <span class="label label-success-outline m-r-15"><?php echo display('billing_to') ?></span>
            <address> 
                <strong style="font-size: 20px; "><?php echo html_escape($customer_info->customer_name); ?> </strong>
                <?php echo html_escape($customer_info->customer_address); ?>
                ...
                <?php if ($customer_info->customer_email) { ?>
                    ...
                    <?php echo html_escape($customer_info->customer_email); ?>
                <?php } ?>
                                        ...
                                        <?php } ?>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($invoice_detail as $service) {
                                                        ...
                                                        <tr>
                                                            <td><?php echo $ssl ?></td>
                                                            <td class="text-left"><?php echo html_escape($service['service_name']); ?></td>
                                            ...
                                            <td style="text-align: right;padding-right: 10px; "  style="border: 0px"><b><?php echo html_escape($subTotal_quantity);?></b></td>
            ...
            <div class="row">
                                    ...
                                    <div class="row" style="margin-top: 50px">
                                        <div style="width: 50%; margin-left: 30px; ">
                                            <strong><?php echo display('description') ?> : </strong> <?php echo html_escape($details); ?>
                                        </div>
                                    </div>
