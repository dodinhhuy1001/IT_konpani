                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                                ...
                                                ?>
                                                <a href="<?php echo base_url('Cproduct/type_delete/{type_id}')?>" class="btn btn-danger btn-sm" name="" onclick="return confirm('Are You Sure ?')" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                                <?php }?>
                                            </center>
                                        </td>
                                        <?php } ?>
