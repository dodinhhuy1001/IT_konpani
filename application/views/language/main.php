            ...
            <div class="col-sm-12">
                <?php
                  if($this->permission1->method('add_phrase','create')->access()){ ?>
                   <a href="<?php echo base_url('Language/phrase') ?>" class="btn btn-info"><?php echo display('add_phrase');?></a>
                <?php
                }
                 elseif($this->permission1->method('add_phrase','read')->access()){
                ?>
                  <a href="<?php echo base_url('Language/phrase') ?>" class="btn btn-info"><?php echo display('manage_phrase');?></a>
                <?php
                 }
                ?>
            </div>
                                ...
                                <tbody>
                                    <?php if (!empty($languages)) {?>
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                            if($this->permission1->method('add_phrase','update')->access()){ ?>
                                              <td><a href="<?php echo base_url("Language/editPhrase/$key") ?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a></td>
                                            <?php } ?>
                                        </tr>
                                        <?php } ?>
                                    <?php } ?>
