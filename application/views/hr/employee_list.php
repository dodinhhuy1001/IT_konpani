...
<div class="content-wrapper">
                    ...
                    <div class="panel-body">
                        ...
                        <th class="text-center"><?php echo display('action') ?></th>
                                ...
                                <td class="text-center"><?php echo html_escape($employees['email']);?></td>
                                 <td class="text-center"><img src="<?php echo html_escape($employees['image']);?>" height="60px" width="70px"></td>
                                            <td>
                                    <center>
                                        <?php echo form_open() ?>
    ...
    <?php if($this->permission1->method('manage_employee','delete')->access()){ ?>                                
                                        <a href="<?php echo base_url('Chrm/employee_delete/'.$employees['id']);?>" class="btn btn-danger btn-sm" name="<?php echo $employees['id']?>" onclick="return confirm('Are You Sure to Want to Delete ??')" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                         <?php }?>
                                   <a href="<?php echo base_url('Chrm/employee_details/'.$employees['id']);?>" class="btn btn-warning btn-sm"><i class="fa fa-user"></i></a>
                                            <?php echo form_close() ?>
                                    </center>
                                    </td>
                                    </tr>
