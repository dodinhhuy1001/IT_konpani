            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <?php echo form_dropdown('designation',$desig,html_escape($employee_data[0]['designation']),'class="form-control"') ?>
                        </div>
                         <label for="phone" class="col-sm-2 col-form-div"><?php echo display('phone') ?> <i class="text-danger">*</i></label>
                        <div class="col-sm-4">
                            <input name="phone" class="form-control" type="number" placeholder="<?php echo display('phone') ?>" id="phone" value="<?php echo html_escape($employee_data[0]['phone'])?>">
                        </div>
                    </div>
                    <div class="form-group row">
               ...
               <option value="<?php echo html_escape($employee_data[0]['country']);?>" selected><?php echo html_escape($employee_data[0]['country']);?></option>
