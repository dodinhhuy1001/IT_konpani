...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php if($this->permission1->method('manage_designation','delete')->access()){ ?>                                
                                        <a onclick="return confirm('Are You Sure?')" href="<?php echo base_url('Chrm/designation_delete/'.$designations['id']) ?>" class="btn btn-danger btn-sm" name="<?php echo $designations['id']?>" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                    <?php }?>
