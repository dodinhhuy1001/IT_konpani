                   ...
                   <?php echo form_open_multipart('Csettings/update_bank/'.$bank_list[0]['bank_id'],array('class' => 'form-vertical','id' => 'validate' ))?>
                    <div class="panel-body">
                    	...
                    	<div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="bank_name" id="bank_name" required="" placeholder="<?php echo display('bank_name') ?>" value="<?php echo html_escape($bank_list[0]['bank_name'])?>" tabindex="1"/>
                                <input type="hidden" name="oldname" value="<?php echo html_escape($bank_list[0]['bank_name'])?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="ac_name" id="ac_name" required="" placeholder="<?php echo display('ac_name') ?>" value="<?php echo html_escape($bank_list[0]['ac_name'])?>" tabindex="2"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="ac_no" id="ac_no" required="" placeholder="<?php echo display('ac_no') ?>" value="<?php echo html_escape($bank_list[0]['ac_number'])?>" tabindex="3"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="branch" id="branch" required="" placeholder="<?php echo display('branch') ?>" value="<?php echo html_escape($bank_list[0]['branch'])?>" tabindex="4"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="hidden" name="old_pic"  value="<?php echo html_escape($bank_list[0]['signature_pic'])?>"/>
                                <img src="<?php echo html_escape($bank_list[0]['signature_pic'])?>" class="img img-responsive" height="80" width="80">
                            </div>
                        </div>
