                ...
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="from_date" name="from_date" value="<?php echo html_escape($today); ?>" class="form-control datepicker" required/>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        if ($ledger) {
                                            ...
                                            <?php foreach ($ledger as $value) {
                                                ?>
                                                <tr>
                                                    <td class="text-center"><?php echo html_escape($value['date']) ?></td>
                                                    <td align="center"><?php echo html_escape($value['details']) ?></td>
                                                    <td align="right"><?php
