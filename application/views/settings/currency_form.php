                   ...
                   <?php echo form_open_multipart('Currency/submit_currency',array('class' => 'form-vertical','id' => 'currency_entry' ))?>
                    <div class="panel-body">
                    	...
                    	<div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="currency_name" id="currency_name" required="" placeholder="<?php echo display('currency_name') ?>" value="<?php echo (!empty($cuerrencyinfo[0]['currency_name'])?html_escape($cuerrencyinfo[0]['currency_name']):'')?>"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="currency_icon" id="cur_icon" required="" placeholder="<?php echo display('currency_icon') ?>" value="<?php echo (!empty($cuerrencyinfo[0]['icon'])?html_escape($cuerrencyinfo[0]['icon']):'')?>"/>
                            </div>
                        </div>
