...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small><?php echo display('edit_role') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('permission') ?></a></li>
                <li class="active"><?php echo display('edit_role') ?></li>
            </ol>
        </div>
    </section>
                    ...
                    <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h4><?php echo display('edit_role') ?> </h4>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" name ="type" id="category_name" type="text" placeholder="<?php echo display('category_name') ?>"  required="" value="<?php echo html_escape($type)?>">
                                </div>
                            </div>
                            <input type="hidden" value="<?php echo html_escape($id);?>" name="id">
