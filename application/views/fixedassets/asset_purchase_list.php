                        ...
                        <div class="table-responsive">
                            <table id="" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                 ...
                                 <a href="<?php echo base_url() . 'Fixedassets/purchase_print/{id}'; ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo 'Print Purchase' ?>"><i class="fa fa-fax" aria-hidden="true"></i></a>
