                        ...
                        <div class="row">
                             <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="" class="form-control" id="item_code" name="item_code" placeholder="<?php echo display('item_code') ?>"  required />
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" tabindex="" class="form-control text-right" id="price" name="price" placeholder="0.00"  required />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" name="previous_stock" class="form-control" id="previous_stock" tabindex="4" placeholder="<?php echo display('opening_assets') ?>">
                                    </div>
                                </div> 
                            </div>
