            ...
            <div class="panel-body">
                ...
                <div class="">
                    <table width="100%" class="table_boxnew" cellpadding="6" cellspacing="1">
                        <tr>
                        <tr align="center">
                            <td colspan="7"><font size="+1"> <strong><?php echo display('cash_book_report_on')?> <?php echo html_escape($FromDate); ?> <?php echo display('to')?> <?php echo html_escape($ToDate);?></strong></font><strong>
                            </th>
                            </strong></tr>
