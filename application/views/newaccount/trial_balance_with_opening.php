                    ...
                    <table width="100%" class="table table-bordered">
                        <tr>
                            <td colspan="4" align="center">
                             ...
                             <?php echo display('from');?> <?php echo html_escape($dtpFromDate); ?> <?php echo display('to');?> <?php echo html_escape($dtpToDate);?></h3>
                            </td>
                        </tr>
                        <tr class="table_head">
                        ...
                        <?php
                            ...
                            if($oResultTrial->Credit!=$oResultTrial->Debit)
                            {
                                ...
                                $k++; ?>
                            <tr class="table_data">
                              <td  align="center" bgcolor="<?php echo $bg;?>"><a href="javascript:"><?php echo html_escape($oResultInEx[$i]['HeadCode']);?>
                               </a>
                              </td>
                              <td  align="center" bgcolor="<?php echo $bg;?>"><?php echo html_escape($oResultInEx[$i]['HeadName']);?></td>
                              <?php
                                if($oResultTrial->Debit>$oResultTrial->Credit)
                                {
                              ?>
