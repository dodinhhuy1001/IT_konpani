                    ...
                    <table class="datatable2 table table-bordered table-hover">
                     ...
                     ?>
                              <tr id="show_vouchar">
                                  <td>
                                     <a href="<?php echo base_url("accounts/vouchar_cash/".$date) ?>">
                                          <?php echo "CV-BAC-".html_escape($date);?>
                                     </a>
                                  </td>
                                  ...
                                  <td align="center"><?php  echo html_escape($date); ?></td>
                              </tr>
                          <?php
                          foreach($get_vouchar as $v_data){
                              ...
                              ?>
                              <tr>
                                  <td><a href="<?php echo base_url("accounts/vouchar_view/$v_data->VDate") ?>"><?php echo html_escape($v_data->VNo);?></a></td>
                                  <td><?php echo html_escape($v_data->Narration);?></td>
