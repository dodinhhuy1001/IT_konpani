...
<div id="printArea">
            <table class="table" width="99%" align="center"  cellpadding="5" cellspacing="5" border="2"> 
                ...
                <tr align="center" class="">
                    ...
                    <td colspan="7"><font size="+1"> <strong ><?php echo display('general_ledger_of').'- '.html_escape($ledger[0]['HeadName']).' ('.display('on')?> <span class="text-"><?php echo html_escape($dtpFromDate) ?></span> <?php echo display('to')?>  <span class="text"> <?php echo html_escape($dtpToDate);?></span>)</strong></font><strong></th></strong>
                </tr>
