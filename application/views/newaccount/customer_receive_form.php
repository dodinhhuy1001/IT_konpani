    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                         ...
                         <?php echo  form_open_multipart('accounts/create_customer_receive') ?>
                     ...
                     <div class="form-group row">
                       ...
                       <div class="table-responsive">
                         ...
                         <select name="customer_id" id="customer_id_1" class="form-control" onchange="load_customerrcv_code(this.value,1)" required>
