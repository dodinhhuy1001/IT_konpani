                    ...
                    <table width="100%" class="table_boxnew" style="padding: 5px">
                        <tr>
                            <td colspan="4" align="center">
                               ...
                               <?php echo display('from');?> <?php echo html_escape($dtpFromDate); ?> To <?php echo html_escape($dtpToDate);?></h3>
                            </td>
                        </tr>
                        <tr class="table_head">
                        ...
                        ?>
                            <tr class="table_data">
                              <td  align="left" bgcolor="<?php echo $bg;?>" style="border-left: solid 1px #000; border-top: solid 1px #000;"><a href="javascript:"><?php echo html_escape($oResultTr[$i]['HeadCode']);?>
                               </a>
                              </td>
                              <td  align="left" bgcolor="<?php echo $bg;?>" style="border-left: solid 1px #000; border-top: solid 1px #000;"><?php echo html_escape($oResultTr[$i]['HeadName']);?></td>
                              <?php
                        ...
                        <?php
                            ...
                            if($oResultTrial->Credit!=$oResultTrial->Debit)
                            {
                                ...
                                $k++; ?>
                            <tr class="table_data">
                              <td  align="left" bgcolor="<?php echo $bg;?>" style="border-left: solid 1px #000; border-top: solid 1px #000;"><a href="javascript:"><?php echo html_escape($oResultInEx[$i]['HeadCode']);?>
                               </a>
                              </td>
                              <td  align="left" bgcolor="<?php echo $bg;?>" style="border-left: solid 1px #000; border-top: solid 1px #000;"><?php echo html_escape($oResultInEx[$i]['HeadName']);?></td>
                              <?php
                                if($oResultTrial->Debit>$oResultTrial->Credit)
                                {
                              ?>
