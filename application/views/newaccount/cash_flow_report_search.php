                ...
                <div class="panel-body">
                  <div>
                      ...
                      <table width="100%" class="table_boxnew" cellpadding="0" cellspacing="0">
                        ...
                        <tr class="table_head">
                            <td colspan="3" align="center"><b>On <?php echo html_escape($dtpFromDate); ?> To <?php echo html_escape($dtpToDate);?></b></td>
                        </tr>
                        <tr class="table_head">
                      ...
                      ?>
                        ...
                        ?>
                          <tr>
                              <td align="left" class="paddingleft10px"><?php echo html_escape($oResultCurrAsset[$s]->HeadName); ?></td>
                              <td>&nbsp;</td>
                      ...
                      if($oResultAmount->Amount!=0)
                      {
                        ?>
                        <tr >
                            <td align="left" class="paddingleft10px"><?php echo html_escape($oResultLiab[$t]->HeadName); ?></td>
                            <td>&nbsp;</td>
                       ...
                       <tr >
                        ...
                        ?>
                        <tr >
                            <td align="left" class="paddingleft10px"><?php echo html_escape($oResultNonCurrAsset[$t]->HeadName); ?></td>
                            <td>&nbsp;</td>
                        ...
                        if($oResultAmount->Amount!=0)
                        {
                            ?>
                        <tr >
                            <td align="left" class="paddingleft10px"><?php echo html_escape($oResultNonCurrLiab[$t]->HeadName); ?></td>
                            <td>&nbsp;</td>
                        ...
                        ?>
                        <tr >
                            <td align="left" class="paddingleft10px"><?php echo html_escape($oResultFund[$t]->HeadName); ?></td>
                            <td>&nbsp;</td>
                            <td align="right" class="cashflowamnt">
                                <?php 
                                    $Total=$oResultAmount->Amount;
                      ...
                      ?>
                        <tr >
                            <td align="left" class="paddingleft10px"><?php echo html_escape($oResultAsset[$i]->HeadName); ?></td>
                            <td>&nbsp;</td>
