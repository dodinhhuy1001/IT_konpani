        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                             <input type="text" name="txtVNo" id="txtVNo" value="<?php echo html_escape($debit_info[0]['VNo']); ?>" class="form-control" readonly>
                        </div>
                    </div> 
                     <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          <select name="cmbDebit" id="cmbDebit" class="form-control">
                            ...
                            <option value="<?php echo html_escape($cracc->HeadCode)?>" <?php if($debit_info[0]['COAID'] == $cracc->HeadCode){
                              echo 'selected';
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                             <input type="text" name="dtpDate" id="dtpDate" class="form-control datepicker" value="<?php echo html_escape($debit_info[0]['VDate']);?>">
                        </div>
                    </div> 
                    <div class="form-group row">
                        <label for="txtRemarks" class="col-sm-2 col-form-label"><?php echo display('remark') ?></label>
                        <div class="col-sm-4">
                          <textarea  name="txtRemarks" id="txtRemarks" class="form-control"><?php echo html_escape($debit_info[0]['Narration']);?></textarea>
                        </div>
                    </div> 
         ...
         <?php }?>
                                        ...
                                        <td><input type="number" name="txtAmount[]" value="<?php echo html_escape($upcrvoucher->Credit) ?>" class="form-control total_price text-right"  id="txtAmount_<?php echo $sl; ?>" onkeyup="dbtvouchercalculation(<?php echo $sl; ?>)" >
                                           </td>
                                       <td>
