                  ...
                  <?php echo form_open_multipart('Csms/add_update_configure', array('class' => 'form-vertical','id' => 'sms_configuration'))?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name ="api_key" value="<?php echo html_escape($configdata[0]['api_key']);?>" id="api_key" type="text" tabindex="1">
                                <input type="hidden" value="<?php echo html_escape($configdata[0]['id']);?>" name="id">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name ="api_secret" value="<?php echo html_escape($configdata[0]['api_secret']);?>" id="api_secret" type="text" tabindex="2">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name ="from" value="<?php echo html_escape($configdata[0]['from']);?>" id="from" type="text" tabindex="3">
                            </div>
                        </div>
                   <div class="form-group row">
