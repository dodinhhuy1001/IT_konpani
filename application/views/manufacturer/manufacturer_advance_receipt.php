                ...
                <div class="panel panel-bd">
                    <div id="printableArea">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <table border="0" width="100%">
                                                ...
                                                <tr>
                                                    <td align="center"><b>{manufacturer_name}</b><br>
                                                        <?php if ($address) { ?>
                                                            {address}<br>
                                                        <?php } ?>
                                                        <?php if ($mobile) { ?>
                        ...
                        <td align="center"><nobr><?php echo ($status == 'Payment')?$details[0]['Debit']:$details[0]['Credit'];?></nobr></td>
                                ...
                                <tr><td><?php echo html_escape($details[0]['Narration']);?></td></tr>
                                <tr>{company_info}
                    ...
                    <div class="panel-footer text-left">
                        <a  class="btn btn-danger" href="<?php echo base_url('Cmanufacturer/manufacturer_advance'); ?>"><?php echo display('cancel') ?></a>
