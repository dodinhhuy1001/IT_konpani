                   ...
                   <?php echo form_open_multipart('Caccounts/create_tax_settins',array('class' => 'form-vertical','id' => 'tax_settings' ))?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <label for="number_of_tax" class="col-sm-3 col-form-label"><?php echo display('number_of_tax') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-3">
                                <input type="number" class="form-control" name="nt" id="number_of_tax" required="" placeholder="<?php echo display('number_of_tax') ?>" onkeyup="add_columnTaxsettings(this.value)" onchange="add_columnTaxsettings(this.value)" />
                            </div>
                        </div>
