...
<div class="form-container">
    <form class="form-vertical" action="<?php echo base_url()?>Cdeposit/deposit_update" id="deposit_update" method="post"  name="deposit_update" enctype="multypart/formdata">
