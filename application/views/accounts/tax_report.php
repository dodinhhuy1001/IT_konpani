            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo html_escape($taxvalue['date']);?></td>
                                     ...
                                     foreach($taxes as $taxfield){
                                        $txval = 'tax'.$x;
                                        ?>
                                    <td class="tax<?php echo $x;?> text-right"><?php echo html_escape($taxvalue[$txval]);?></td>
                                     <?php $x++;}?>
                                </tr>
                            <?php $sl++;
                        }?>
                    ...
                    <?php }?>
                       ...
                       <input type="hidden" name="taxnumber" id="taxnumber" value="<?php echo html_escape($taxnumber);?>">
                    </div>
